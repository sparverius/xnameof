...
ATS_MAINATSFLAG 1
#define
ATS_DYNLOADNAME "libxnameof_dynloadall"
#endif // #ifdef
...
if
(argc >= 2)
then nameof0_main0(argc, argv)
else prerrln! ("Hello from ATS3(xnameof)!")
// end of [if]
) (* end of [main] *)
#endif // ifdef(_LIBXNAMEOF_)
//
(* ****** ****** *)
